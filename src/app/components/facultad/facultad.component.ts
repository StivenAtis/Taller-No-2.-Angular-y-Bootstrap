...
export class FacultadComponent {
  ...
  saber: { lecturaCritica: 0, ingles: 0, ciudadanas: 0, razonamiento: 0, comunicacionEscrita: 0 },
  porsaberpro: { lecturaCritica: 0, ingles: 0, ciudadanas: 0, razonamiento: 0, comunicacionEscrita: 0 },
  porsaber: { lecturaCritica: 0, ingles: 0, ciudadanas: 0, razonamiento: 0, comunicacionEscrita: 0 },
  valoragregado: { lecturaCritica: 0, ingles: 0, ciudadanas: 0, razonamiento: 0, comunicacionEscrita: 0 }};
  ...
  buscarPrograma(programaId: string): void {
    for (let index = 0; index < this.programas.length; index++) {
      ...
      if (element.id === programaId) {
        ...
        this.estudianteSeleccionado = this.estudiantesSeleccionados[0] || { id: "", nombre: "", saberPro: { lecturaCritica: 0, ingles: 0, ciudadanas: 0, razonamiento: 0, comunicacionEscrita: 0 }, saber: { lecturaCritica: 0, ingles: 0, ciudadanas: 0, razonamiento: 0, comunicacionEscrita: 0 } };
        break;
      }
    }
  }
